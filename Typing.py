...
def starter():
    ...
    while True:
        starter = getchar()
        if ord(starter) == 13:
            for i in tqdm(range(20),ncols=120):
                sleep(0.1)
            system('cls')
            game()
        else:
...
def game():
    ...
    while (time_2 - time_1) < 60:
        ...
        if n not in numb:
            numb.append(n)
            print(co.Fore.GREEN + co.Style.BRIGHT + lst[n], co.Fore.YELLOW + co.Style.BRIGHT +  "\t|\tyour left time is : ",end="")
            time_2 = time()
            ...
            while True:
                ...
                if ord(ch) == 8:
                    word = delete(word)
                    system('cls')
                    print(co.Fore.GREEN + co.Style.BRIGHT + lst[n],end = co.Fore.YELLOW + co.Style.BRIGHT +  "\t|\tyour left time is : ")
                    time_2 = time()
